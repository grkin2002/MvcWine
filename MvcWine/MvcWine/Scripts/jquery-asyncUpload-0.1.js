...
(function($) {
    $.fn.makeAsyncUploader = function(options) {
        return this.each(function() {
            ...
            container.append($("<input type='hidden' name='PhotoUrl' />"));
            container.append($("<br/>"));
            //container.append($("<span class='left'><img id='Photo' hight='200' src='' /></span>"));
            ...
            var defaults = {
                ...
                upload_success_handler: function(file, response) {
                    $("input[name=PhotoUrl]", container).val(response);
                    //$("img[id=Photo]", container).src(response);
                ...
                upload_complete_handler: function() {
                    var clearup = function() {
                        ...
                        //$("img[id=Photo]", container).show();
                        $("span[id$=_uploading]", container).hide();
                        swfu.setButtonDimensions(width, height);
                    };
                    if ($("input[name=PhotoUrl]", container).val() != "") // Success
